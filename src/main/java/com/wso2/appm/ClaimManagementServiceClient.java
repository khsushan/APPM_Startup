...
public class ClaimManagementServiceClient {
    ...
    public  void  addClaim(String description,String claimURI,boolean isRequired) throws RemoteException, ClaimManagementServiceException {

        //claimDialectDTO.setUserStore("");
